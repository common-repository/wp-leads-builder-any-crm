...
class thirdparty_mapping
{
	public function get_assignedto($shortcode_option)
	{
		...
		case 'wpzohopluspro':
			$html_leads = "";
			$html_leads = '<select data-live-search="true" class="selectpicker form-control"  name="mapping_assignedto" id="mapping_assignedto">';
		...
		case 'joforce':
			$html_leads = "";
			$html_leads = '<select data-live-search="true" class="selectpicker form-control" name="mapping_assignedto" id="mapping_assignedto" style="min-width:69px;">';
			$content_option_leads = "";
	...
	public function get_mapping_config($get_wp_config,$get_cf_config,$get_config)
	{

		$html_config = "";
		$html_config .= "<div>
			<div class='form-group col-md-12 mt20'> <div class='exist_mapping col-md-6'>
				 <label id='innertext' class='leads-builder-label'> Choose Your Module </label>
				 </div>
			<div class='exist_mapping col-md-4'> <select id='map_thirdparty_module' class='selectpicker form-control' data-live-search='true' name='map_thirdparty_module'  onchange=''>";

		$html_config .= "<option value='none'>None</option>
			<option value='Leads'>Leads</option>
			<option value='Contacts' disabled>Contacts (PRO)</option >
			</select></div></div><br><br>";

		$html_config .= "<div class='form-group col-md-12 mt20 mb50'>
		 <div class='exist_mapping col-md-6'> <label id='innertext' class='leads-builder-label'> Choose Your Plugin
		</label></div>
			<div class='exist_mapping col-md-4'> <select id='map_thirdparty_form' class='selectpicker form-control' data-live-search='true' name='map_thirdparty_form' onchange='get_mapping_configuration(this.value)'>";
		$html_config .= "<option value='none'>None</option>";

			if(empty($get_cf_config))
			{
				$html_config .= "<option value='contactform'>Contact Form</option>";
			}
			else if(!empty($get_cf_config)){
			...
			if(empty($get_wp_config))
			{
				$html_config .= "<option value='wpform'>WP Forms</option>";
			}
			else{
				$html_config .= "<option value='wpform' disabled>WP Forms</option>";
			}	

			if(empty($get_config))
			{
				$html_config .= "<option value='wpformpro'>WP Forms Pro</option>";
			}
			else{
				$html_config .= "<option value='wpformpro' disabled>WP Forms Pro</option>";
			}	

			$html_config .=	"
			<option value='calderaform'>Caldera Form</option>
			<option value='ninjaform ' disabled>Ninja Forms</option>
			<option value='gravityform' disabled>Gravity Forms</option>
			</select></div></div></div>";
	...
	'form' => ['method' => true, 'name' => true, 'id' => true, 'action' => true]];
		...
		case "gravityform":
			...
			$html = "<div> <div class='form-group col-md-12'> 
							<div class='col-md-6'>
								<div id='inneroptions' class='leads-builder-heading'> Gravity Form</div> 
							</div>
					</div>
				<div class='form-group col-md-12'> 
					<div class='exist_mapping col-md-6'>
						 <label id='innertext' class='leads-builder-label'> Choose Any One Of the Form </label>
					</div>
				<div class='exist_mapping col-md-4'> 
					<select class='selectpicker form-control' id='thirdparty_form_title' name='thirdparty_form_title' onchange='get_thirdparty_title(this.value , \"gravityform\" , \"$tp_module\" )'>";
			$option_content = '';
		...
		case "ninjaform":
			...
			$html = "<div> <div class='form-group col-md-12'> <div class='col-md-6'><div id='inneroptions' class='leads-builder-heading'> Ninja Form</div> </div></div>
				...
				<div class='exist_mapping col-md-4'> <select class='selectpicker form-control' id='thirdparty_form_title' name='thirdparty_form_title' onchange='get_thirdparty_title(this.value , \"ninjaform\" , \"$tp_module\")'>";
			$option_content = '';
			$option_content = "<option value='--None--'>--None--</option>";
			 ...
			 if( !empty( $list_of_shortcodes ))
			{
				?>
					<script>
							alert("please upgrade to pro to use more than one thirdparty forms");
			...
			$html = "";
			$html = "<div> <div class='form-group col-md-12'><div class='col-md-6'>
			 <div id='inneroptions' class='leads-builder-heading'> Contact Form7</div> 
			 </div></div>
				<div class='form-group col-md-12'> <div class='exist_mapping col-md-6'>
				 	<label id='innertext' class='leads-builder-label'> Choose Any One Of the Form</label>
				</div>
				<div class='exist_mapping col-md-4'> <select id='thirdparty_form_title' class='selectpicker form-control' data-live-search='true' name='thirdparty_form_title' onchange='get_thirdparty_title(this.value , \"contactform\" , \"$tp_module\")'>";
			$option_content = '';
			$option_content = "<option value='--None--'>--None--</option>";
			...
			$html = "<div> <div class='form-group col-md-12'><div class='col-md-6'> <div id='inneroptions' class='leads-builder-heading'> WP Forms</div> </div></div>
				<div class='form-group col-md-12'> <div class='exist_mapping col-md-6'> <label id='innertext' class='leads-builder-label'> Choose Any One Of the Form</label></div>
				<div class='exist_mapping col-md-4'> <select id='thirdparty_form_title' class='selectpicker form-control' data-live-search='true' name='thirdparty_form_title' onchange='get_thirdparty_title(this.value , \"wpform\" , \"$tp_module\")'>";
			$option_content = '';
			$option_content = "<option value='--None--'>--None--</option>";
			...
			$html = "<div> <div class='form-group col-md-12'><div class='col-md-6'> <div id='inneroptions' class='leads-builder-heading'> WP Forms Pro</div> </div></div>
				<div class='form-group col-md-12'> <div class='exist_mapping col-md-6'> <label id='innertext' class='leads-builder-label'> Choose Any One Of the Form</label></div>
				<div class='exist_mapping col-md-4'> <select id='thirdparty_form_title' class='selectpicker form-control' data-live-search='true' name='thirdparty_form_title' onchange='get_thirdparty_title(this.value , \"wpformpro\" , \"$tp_module\")'>";
			$option_content = '';
			$option_content = "<option value='--None--'>--None--</option>";
			foreach( $wpf_form_titles as $option_key => $option_value )
			{       $form_id = $option_value['id'];
		...
		case "calderaform":
			...
			$html = "<div> <div class='form-group col-md-12'> <div class='col-md-6'><div id='inneroptions' class='leads-builder-heading'> Caldera Form</div> </div></div>
				<div class='form-group col-md-12'> <div class='exist_mapping col-md-6'> <label id='innertext' class='leads-builder-label'> Choose Any One Of the Form </label></div>
				<div class='exist_mapping col-md-4'> <select class='selectpicker form-control' id='thirdparty_form_title' name='thirdparty_form_title' onchange='get_thirdparty_title(this.value , \"calderaform\" , \"$tp_module\")'>";
			$option_content = '';
			$option_content = "<option value='--None--'>--None--</option>";
	...
	public function get_thirdparty_form_fields()
	{
		...
		case 'gravityform':
			...
			$map_options .= "<div>	
				...
				<div class='exist_mapping col-md-4'> <select class='selectpicker form-control' id='duplicate_handling'><option value='skip'";
			...
			if( $thirdparty_form_name != "--None--" )
			{
				...
				foreach( $gravity_form_labels as $grav_id => $grav_label)
				{
					...
					$fields_html .= "<div class='exist_mapping col-md-4'><select class='selectpicker form-control' data-live-search='true'  name='crm_fields_$i' id='crm_fields_$i' >";
					$crm_field_options = '';
					$crm_field_options .= "<option>--None--</option>";
			...
			echo wp_json_encode($html_data_array);
			die;
			break;
		...
		case 'contactform':
			...
			$config = get_option( $shortcode );
			$contact_config = isset($config['fields']) ? $config['fields'] :'';
			$assigned_to_user = $this->get_assignedto($shortcode);
			$map_options = '';
			$map_options .= "<div>	
				<div class='form-group col-md-12'> <div class='exist_mapping col-md-6'> <label id='innertext' class='leads-builder-label'> Duplicate Handling</label> </div> 
			...
			$map_options .= "disabled > Skip</option>
				<option value='skip_both'";
			if( isset( $config['thirdparty_duplicate']) && $config['thirdparty_duplicate'] == 'skip_both' )
			{
				$map_options .= "selected=selected";
			}
			$map_options .= " disabled> Skip if already a Contact or Lead</option>
			...
			$map_options .= "disabled>Update</option> <option value='create'";
			if( isset( $config['thirdparty_duplicate']) && $config['thirdparty_duplicate'] == 'create' )
			{
				$map_options .= "selected=selected";
			}
			...
			if( $thirdparty_form_name != '--None--' )
			{
				...
				foreach( $contact_form_labels as $cont_id => $cont_label)
				{
					...
					$fields_html .= "<div class='col-md-4'><select data-live-search='true' class='selectpicker  form-control'  name='crm_fields_$i' id='crm_fields_$i' >";
					$crm_field_options = '';
					$crm_field_options .= "<option>--None--</option>";
					foreach( $crm_field_labels as $field_key => $crm_field_label ) // Prepare crm fileds drop down
					{
			...
			case 'wpform':
				...
				$config = get_option( $shortcode );
				$wpform_config = isset($config['fields']) ? $config['fields'] :'';
				$assigned_to_user = $this->get_assignedto($shortcode);
				$map_options = '';
				$map_options .= "<div>	
					<div class='form-group col-md-12'> <div class='exist_mapping col-md-6'> <label id='innertext' class='leads-builder-label'> Duplicate Handling</label> </div> 
			...
			case 'calderaform':
				...
				if( $thirdparty_form_name != '--None--' )
				{
					...
					$i = 1;	
					foreach( $caldera_form_labels as $cont_id => $cont_label)
					{
						$fields_html .= "<div class='form-group col-md-12'>
							<div class='col-md-6'><label class='leads-builder-label'> $cont_label </label></div>
							<input type='hidden' name='thirdpartyfield_$i' id='thirdpartyfield_$i' value='$cont_id' />";
	...
	public function map_thirdparty_form_fields()
	{
		...
		foreach($fields as $fieldKey => $fieldVal ){
			if(is_array($fieldVal)){
				$config_data = array_map( 'sanitize_text_field', $fieldVal );
			} 
			else {
				if($fieldKey == 'form_title'){
					$form_title = sanitize_text_field($fieldVal);
				}
				else if($fieldKey == 'third_plugin'){
					$third_plugin = sanitize_text_field($fieldVal);
				}
				else if($fieldKey == 'third_module'){
					$third_module = sanitize_text_field($fieldVal);
				}
				else if($fieldKey == 'third_crm'){
					$third_crm = sanitize_text_field($fieldVal);
				}
				else if($fieldKey == 'third_duplicate'){
					$third_duplicate = sanitize_text_field($fieldVal);
				}
				else if($fieldKey == 'third_assigedto'){
					$third_assignedto = intval($fieldVal);
				}
				else if($fieldKey == 'assignedto_name'){
					$third_assignedto_name  = sanitize_text_field($fieldVal);
				}
			}
		}
		...
		case 'ninjaform':
			...
			{		
				...
				foreach( $ninja_form_labels as $nin_id => $nin_label)
				{
					...
					$fields_html .= "<div class='exist_mapping col-md-4'><select data-live-search='true' class='selectpicker form-control'  name='crm_fields_$i' id='crm_fields_$i' >";
					$crm_field_options = '';
					$crm_field_options .= "<option>--None--</option>";
					foreach( $crm_field_labels as $field_key => $crm_field_label ) // Prepare crm fileds drop down
					{
		...
		case 'contactform':
			...
			if( $thirdparty_form_name != '--None--' )
			{
				...
				foreach( $contact_form_labels as $cont_id => $cont_label)
				{
					...
					$fields_html .= "<div class='col-md-4'><select data-live-search='true' class='selectpicker form-control' style='width:150px;' name='crm_fields_$i' id='crm_fields_$i' >";
					$crm_field_options = '';
					$crm_field_options .= "<option>--None--</option>";
					foreach( $crm_field_labels as $field_key => $crm_field_label ) // Prepare crm fileds drop down
					{
